...
class YoloV7Onnx(ODModel):
    ...
    def coco(
        ...
        try:
            model_path = download_file(
                "https://github.com/BergLucas/ImageAnalystONNX-models/releases/download/v1.0.0/onnx-yolov7-coco.onnx",  # noqa: E501
                "onnx-yolov7-coco.onnx",
                report_callback,
            )
            labels_path = download_file(
                "https://github.com/BergLucas/ImageAnalystONNX-models/releases/download/v1.0.0/onnx-yolov7-coco.names",  # noqa: E501
    ...
    def tiny_coco(
        ...
        try:
            model_path = download_file(
                "https://github.com/BergLucas/ImageAnalystONNX-models/releases/download/v1.0.0/onnx-yolov7-tiny-coco.onnx",  # noqa: E501
                "onnx-yolov7-tiny-coco.onnx",
                report_callback,
            )
            labels_path = download_file(
                "https://github.com/BergLucas/ImageAnalystONNX-models/releases/download/v1.0.0/onnx-yolov7-tiny-coco.names",  # noqa: E501
